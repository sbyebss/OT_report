...
\begin{table}[htbp]
  ...
  \multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}fixed segmented\\ 7 stair function\end{tabular}} & \begin{tabular}[c]{@{}l@{}}6 layers\\ 300n/l\end{tabular} & No                                                                            & 0.1670 &                                                                                             &  \\ \cline{1-5}
  \end{tabular}
...
In this section, we don't have a well-organized initializations for $f$ as there is no previous paper reference.\\
1) \textbf{No initialization}:\\
