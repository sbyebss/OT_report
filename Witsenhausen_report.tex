...
Secondly, if we treat the loss criteria as comparison between $F$ with the piecewise linear function $F_0$, the $f_0$ would becomes much better as Fig.5 and Fig.6:
\begin{figure}[htp]
  \centering
  \includegraphics[width=6cm]{images/ICNN_f_init.png}
  \caption{7-step-stair $f_0$, $f_0$ is from initialization process with criteria between $F_0$ and ideal integral function}
  \label{fig:train result}
\end{figure}

\begin{figure}[htp]
  \centering
  \includegraphics[width=6cm]{images/segmented_f_init.png}
  \caption{7-step-stair $f_0$, $f_0$ is from initialization process with criteria between $F_0$ and ideal integral function}
  \label{fig:train result}
\end{figure}
  ...
  \begin{figure}
    \centering
        ...
        \begin{subfigure}[b]{0.2\textwidth}
                ...
                \label{fig:4-step f}
        \end{subfigure}
        \caption{Different result caused by Adam instability}\label{fig:Different result caused by Adam instability}
    \end{figure}
  
  As a result, afterwards if there is no more specification, we always use RAdam as the optimizer. This is very foundamental result for the experiments afterwards.\\
...
\begin{table}[htbp]
  ...
  The $f$ and $g$ shape of the best result: $J^C$=0.167 is shown below:
  \begin{figure}[htp]
    \centering
    \includegraphics[width=6cm]{images/fixedFfunction.png}
    \caption{Fixed $f$ as a step function to obtain best result:0.167}
    \label{fig:fixedFfunction}
\end{figure}

\begin{figure}[htp]
  \centering
  \includegraphics[width=6cm]{images/g_fixedFfunction.png}
  \caption{$g$ solution while taking $f$ fixed as a step function}
  \label{fig:g_fixedFfunction}
\end{figure}
...
This didn't behave better than ICNN structure. While taking $f$ as 6 layers and 300n/l, $g$ as 6 layers and 300n/l, $J^C\rightarrow$ 0.2153 as below:
\begin{figure}[htp]
  \centering
