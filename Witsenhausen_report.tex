...
\begin{table}[htbp]
  ...
  In the Table \ref{table:segmented-7-stair-init table results}, n/l means the number of units each layer. From which we could tell the $f$ structure matters a lot. If $f$ is not shaped well, sometimes continuing updating $f$ with $f$ fixed would only make the cost worse. 
