...
\begin{table}[htbp]
  ...
  \begin{figure}
    \centering
        ...
        \end{subfigure}
        \caption{$J^C=0.1739$ corresponding solutions}\label{fig:Different result caused by Adam instability}
    \end{figure}
    ...
    \begin{figure}
      \centering
          ...
          \begin{subfigure}[b]{0.2\textwidth}
                  ...
                  % \label{fig:g_update_2_best}
          \end{subfigure}
          \caption{Fix $f$ as a stair function corresponding solutions}\label{fig:fixedFfunction}
      \end{figure}
