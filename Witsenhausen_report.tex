...
\begin{table}[htbp]
  ...
  \multirow{4}{*}{6 layers}                                                                        & \begin{tabular}[c]{@{}l@{}}3 layer\\ 100n/l\end{tabular} & Yes                                                                           & 0.2050 &                                                                                             &  \\ \cline{2-5}
                                                                                                   ...
                                                                                                   & \begin{tabular}[c]{@{}l@{}}3 layer\\ 300n/l\end{tabular} & No                                                                            & 0.1758 & \begin{tabular}[c]{@{}l@{}}fix f, then\\ update g:\\ $J^C\rightarrow$ 0.1754\end{tabular} &  \\ \cline{2-5}
                                                                                                   & \begin{tabular}[c]{@{}l@{}}6 layer\\ 300n/l\end{tabular} & No                                                                            & 0.1739 & \begin{tabular}[c]{@{}l@{}}fix f, then\\ update g:\\ $J^C\rightarrow$ 0.1746\end{tabular} &  \\ \cline{1-5}
  ...
  In the Table 2, n/l means the number of units each layer.
