...
\begin{tikzpicture}[cross/.style={path picture={ 
  ...
  % Dialectics
  \node[draw] (x0) at (0,8) {$h_{input}\sim P$};
  \node[draw] (N) at (3,8) {$N$};
  \node[draw,,fill=gray,text=white] (fNN) at (0,7) {$h$ NN};
  \node[draw] (x1) at (0,6) {$\tilde{x}\sim Q$};
...
\node[draw,fill=gray,text=white] (MSE1) at (-4,7) {$W_2(P,Q)$};
